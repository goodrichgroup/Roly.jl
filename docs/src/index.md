...
- [Orientation and registrations](orientation.md) covers what a bond fixes about the two particles' relative orientation, and how to control it. Worth reading if a species does not enumerate what you expected.
